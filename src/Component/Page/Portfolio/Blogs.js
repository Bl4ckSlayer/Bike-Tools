    ...
    <div className="m-12">
      <div className="bg-slate-500 p-4 rounded-lg">
        ...
        <p className="text-xl text-warning">
          Optimizing performance in a React application: Keeping component state
          local where necessary. emoizing React omponents to prevent unnecessary
          re renders. Code splitting in React using dynamic import() Windowing
          or list virtualization in React. Lazy loading images in React. The
          solution is to create a functional component that will collect all
          props and redistribute them to other components.
        </p>
      </div>
      <div className="bg-slate-500 p-4 rounded-lg mt-6">
        <h1 className="text-black font-bold text-2xl">
        ...
        <p className="text-xl text-warning">
          ...
          managing states shared across components becomes difficult. There are
      ...
      <div className="bg-slate-500 p-4 rounded-lg mt-6">
        ...
        <p className="text-xl text-warning">
          Because of the following, it is never a good idea to change the state
          directly: If you alter it directly, executing setState() subsequently
          might just overwrite your changes. This.state does not change
          instantly when you directly update the state. Instead, it generates a
          pending state transition, which will only return the current value
          when accessed after calling this function.
        </p>
      </div>
      <div className="bg-slate-500 p-4 rounded-lg mt-6">
        <h1 className="text-black font-bold text-2xl">
        ...
        <p className="text-xl text-warning">
          ...
          engineers to confirm that a piece of an application (referred to as a
          unit matches its design and operates as intended.Before code is
          ...
          Unit testing saves time and money during the product development life
          cycle.
        </p>
      </div>
    </div>
